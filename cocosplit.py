"""
cocosplit.py from: https://github.com/akarazniewicz/cocosplit/blob/master/cocosplit.py

Execution: 

python cocosplit.py --having-annotations --multi-class -s 0.8 "data/json_files/custom_train.json" "data/json_files/instances_train.json" "data/json_files/instances_test.json"
...
def main(args):
    ...
    with open(args.annotations, 'rt', encoding='UTF-8') as annotations:
        ...
        info = coco['info'] if 'info' in coco else {}                           # Added exception
        licenses = coco['licenses'] if 'licenses' in coco else {}               # Added exception
        images = coco['images']
